...
@dataclass
class Flickr30kConfig(ExperimentConfig):
    epochs: int = 30
    lr: float = 1e-3
    batch_size: int = 128
    out_dim: int = 256
    ...
    # TinyCLIP training (separate from MLP encoder epochs)
    tinyclip_epochs: int = 10
    ...
    output_dir: str = "outputs/flickr"


def get_flickr_config() -> Flickr30kConfig:
    return Flickr30kConfig()
